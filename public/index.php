...
// criar uma intancia da classe locadora
...
if ($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    // verifica se requer permissao de administrador
    ...
    if(isset($_POST['adicionar'])){
        ...
        $mensagem = "O veículo foi adicionado com sucesso!";
    }
    ...
    elseif(isset($_POST['deletar'])){
        $mensagem = $locadora->deletarVeiculo($_POST['modelo'], $dias);
    }
    elseif(isset($_POST['calcular'], $_POS['placa'])){
